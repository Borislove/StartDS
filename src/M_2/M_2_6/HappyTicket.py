...
если сумма первых трех цифр равна сумме последних трех.
Помогите Маше сосчитать количество счастливых билетиков в ее коллекции.

Входные данные
В первой строке вводится число N - количество билетиков (0⩽N⩽100).
Далее идут N 6-значных чисел, по одному числу в строке.
